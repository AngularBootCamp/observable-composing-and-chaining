...
class RedditImageSearchService {
    ...
    search(subReddit, search) {
        ...
        return this.http
            .get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(translateRedditResults));
    }
}
...
/* harmony import */ var _reddit_image_search_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reddit-image-search.service */ "./src/app/reddit-search/reddit-image-search.service.ts");
...
function RedditSearchComponent_div_11_Template(rf, ctx) { if (rf & 1) {
...
class RedditSearchComponent {
    constructor(ris) {
        ...
        const validSubReddit = this.subReddit.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(this.subReddit.value));
        const validSearch = this.search.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(this.search.value), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(search => search.trim()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(search => search !== ''));
        const combinedCriteria = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])([
            validSubReddit,
            validSearch
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(([subReddit, search]) => ({ subReddit, search })));
        this.results = combinedCriteria.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(val => ris.search(val.subReddit, val.search).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(3), 
        // Clear previous entries while waiting
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])([]))));
    }
}
RedditSearchComponent.ɵfac = function RedditSearchComponent_Factory(t) { return new (t || RedditSearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_reddit_image_search_service__WEBPACK_IMPORTED_MODULE_4__["RedditImageSearchService"])); };
RedditSearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RedditSearchComponent, selectors: [["reddit-search"]], decls: 13, vars: 6, consts: [[1, "three-across"], ["for", "subReddit"], ["id", "subReddit", 3, "formControl"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "search"], ["id", "search", "type", "text", 3, "formControl"], ["class", "box", 4, "ngFor", "ngForOf"], [3, "value"], [1, "box"], [3, "src", "alt"]], template: function RedditSearchComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RedditSearchComponent, [{
    ...
    }], function () { return [{ type: _reddit_image_search_service__WEBPACK_IMPORTED_MODULE_4__["RedditImageSearchService"] }]; }, null);
