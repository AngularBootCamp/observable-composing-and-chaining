# DRAFT - Angular Boot Camp Curriculum - observable-composing-and-chaining
...
[StackBlitz for observable-composing-and-chaining](https://stackblitz.io/github/AngularBootCamp/observable-composing-and-chaining)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/observable-composing-and-chaining.git
cd observable-composing-and-chaining
yarn
yarn start
```
